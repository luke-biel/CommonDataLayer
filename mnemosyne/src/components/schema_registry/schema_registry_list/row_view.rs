...
impl Component for RowView {
    ...
    fn view(&self) -> Html {
        ...
        html! {
            <tr>
                <td>{ self.props.schema.name.as_str() }</td>
                <td><strong>{ self.props.schema.id }</strong></td>
                <td>
                    <button type="button" title="View schema" class="button-primary-outlined button-small" onclick=on_view>
                    ...
                    <button type="button" title="Edit schema" class="button-primary-outlined button-small" onclick=on_edit>
                    ...
                    <button type="button" title="Add schema" class="button-primary-outlined button-small" onclick=on_add>
                        <svg width="1.2em" height="1.2em" viewBox="0 0 16 16">
                        <path style="fill: #4caf50"
                    ...
                    <button type="button" title="View schema history" class="button-primary-outlined button-small" onclick=on_history>
                        <svg width="1.2em" height="1.2em" viewBox="0 0 16 16">
                        <path style="fill: #4caf50"
