use crate::cdl_objects::{CDLSchemaView, CDLSchemas};
use std::rc::Rc;
use uuid::Uuid;
use yew::html;
        ...
        html! {
            <tr>
                ...
                <td class="simple-column">
                    ...
                    <button type="button" title="Edit schema"
...
impl Component for ViewButton {
    type Message = ();
    type Properties = ViewButtonProps;
